...
<body>
    <div class="addroomsection">
        <form action="" method="POST">
            <label for="troom">Location :</label>
            <select name="troom" class="form-control">
                <option value selected></option>
                <option value="Faculty of Science">Faculty of Science</option>
                <option value="Faculty of Computer Science and Information Technolog">Faculty of Computer Science and Information Technology</option>
                <option value="Faculty of Medicine">Faculty of Medicine</option>
                <option value="Faculty of Pharmacy">Faculty of Pharmacy</option>
            </select>

            <label for="bed">Type of Room :</label>
    ...
    <div class="room">
        ...
        while ($row = mysqli_fetch_array($re)) {
            ...
            } else if ($id == "Faculty of Computer Science and Information Technology") {
            ...
            } else if ($id == "Faculty of Medicine") {
            ...
            } else if ($id == "Faculty of Pharmacy") {
